...
app.set('view engine','hbs'); // le damos motor hbs
app.set('views',path.join(__dirname,'views')); // especificamos la ruta de que carpeta va a ser dinamica
app.use(express.static(path.join(__dirname,'public')))

hbs.registerPartials(__dirname + "/views/partials");


app.get('/',(req,res,next)=>res.render('index')); //en laza la root con la index
app.get('/player',(req,res,next)=>{//enlaza con la view de players
    const players = [
        {
          name: "Rusell",
          lastName: "Westbrook",
...
app.get('/teams',(req,res,next)=>{
    ...
    res.render('teams',data); //enlaza con la view teams
}); 
